...
- /想 <文本>、/想 %<模板名> <文本>、/想 list：在 think 模板气泡中填入文字，支持 emoji，自动调整字号与换行
- /盐巴 <文本>：在 salt 模板左上角对白框中填入文字，支持 emoji，自动调整字号与换行
- /男娘 [@群友]：将 xnn 模板叠在头像上，无 @ 则对发送者
"""

from yiyin.meme import symmetric  # noqa: F401
from yiyin.meme import ziming     # noqa: F401
from yiyin.meme import think      # noqa: F401
from yiyin.meme import salt       # noqa: F401
